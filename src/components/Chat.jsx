...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        // As soon as user clicks on chat icon / page loads, join the chat
        ...
        // Disconnect the socket (NOT TO BE FORGOT)
        return () => {
            socket.disconnect();
        }
    }, [userId, targetUserId]);
    ...
    return (
        <div className="w-1/2 mx-auto border border-gray-600 h-[70vh] flex flex-col m-5">
